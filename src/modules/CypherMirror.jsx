...
class CypherMirror extends React.Component {
  ...
  editorProps = {
    ...
    initialOptions: {
      ...
      extensions: [
        /* override extensions  */
      ], // optional, defaults to a sensible list of extensions.
    },
    initialSchema: {
      /* ... */
    }, // optional, see example in demos
        ...
        <Container fluid>
          <Row>
            ...
            <Col className="row-header" xs={2} md={2}>
              <IconButton
                onClick={() => this.props.sendCypher(this.state.editorValue)}
                aria-label="Execute"
                title="Execute"
              >
                <PlayArrowIcon />
              ...
              <IconButton
                onClick={() => this.props.clearEditor()}
