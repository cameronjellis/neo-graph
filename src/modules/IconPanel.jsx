      ...
      <>
        <div>
          <IconButton
            ...
            onClick={() => this.props.displayGraphType("TEXT")}
          >
        ...
        <div>
          <IconButton
            title="Display in Grid View"
            onClick={() => this.props.displayGraphType("GRID")}
          >
        ...
        <div>
          <IconButton
            title="Display in GraphView"
            onClick={() => this.props.displayGraphType("GRAPH")}
          >
        ...
        <div>
          <IconButton
            title="Display DAG"
            onClick={() => this.props.displayGraphType("DAG")}
          >
